...
namespace AutoFrame
{
    ...
    /// 钢琴演奏左机器人
    /// </summary>
    class StationLeftRobot : StationBase
    {
        private TcpLink m_tcpRobotCtl;
        public TimeSpan ticks = TimeSpan.FromMilliseconds(10);
        public StationLeftRobot(string strName) : base(strName)
        {
            io_in = new string[] { };
            io_out = new string[] { };
        ...
        public DataGridView Leftdgv = new DataGridView();
        ...
        public static int currentPos_L = 0;
        /// <summary>
        /// 机器人动作
        /// </summary>
        ...
        /// <summary>
        /// 左手23-36号键替换为9-22号键,并转换成机器人的点位
        /// </summary>
        /// <param name="n_Key"></param>
        /// <returns></returns>
        public int KeyReplace(int n_Key)
        {
            if (n_Key >= 1 && n_Key <= 22) return n_Key;
            else if (n_Key == 23) return 9;
            else if (n_Key == 24) return 10;
            else if (n_Key == 25) return 11;
            else if (n_Key == 26) return 12;
            else if (n_Key == 27) return 13;
            else if (n_Key == 28) return 14;

            else if (n_Key == 29) return 15;
            else if (n_Key == 30) return 16;
            else if (n_Key == 31) return 17;
            else if (n_Key == 32) return 18;
            else if (n_Key == 33) return 19;
            else if (n_Key == 34) return 20;
            else if (n_Key == 35) return 21;

            else if (n_Key == 36) return 22;
            else return 0;
        }
        ...
        {
            if (n_KeyR == 0)//初始化时，说明右边在原点，另一边可以先动作(随便动)
            {
                return true;
            }
            else
